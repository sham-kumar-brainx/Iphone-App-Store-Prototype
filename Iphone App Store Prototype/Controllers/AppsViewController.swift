...
//        appsView.appsCollectionView.register(VerticalCollectionCell.nib(), forCellWithReuseIdentifier: VerticalCollectionCell.reuseIdentifier)
...
//        appsView.appsCollectionView.dataSource = self
        appsView.appsCollectionView.contentInsetAdjustmentBehavior = .scrollableAxes
    }
    ...
    func setupHorizontalScrollSection() -> NSCollectionLayoutSection {
        ...
        let group = NSCollectionLayoutGroup.horizontal(
            layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.90), heightDimension: .absolute(320)), subitem: item, count: 1)
...
//        item.contentInsets = NSDirectionalEdgeInsets(top: 5, leading: 0, bottom: 0, trailing: 15)
        let group = NSCollectionLayoutGroup.vertical(
            layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.0), heightDimension: .absolute(270)), subitem: item, count: 3)
        group.contentInsets = NSDirectionalEdgeInsets(top: 0.0, leading: 16.0, bottom: 0.0, trailing: 16.0)
        let section = NSCollectionLayoutSection(group: group)
